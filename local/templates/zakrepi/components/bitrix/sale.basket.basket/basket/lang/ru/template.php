<?
$MESS["BASKET_HEADER"] = "Корзина";
$MESS["BASKET_CLEAR_BTN"] = "Очистить корзину";
$MESS["BASKET_TABLE_HEADER_PRODUCT"] = "Товар";
$MESS["BASKET_TABLE_HEADER_COUNT"] = "Количество";
$MESS["BASKET_TABLE_HEADER_PRICE"] = "Стоимость";
$MESS["MIN_ORDER_SUMM"] = "Минимальная сумма заказа";
$MESS["FREE_DELIVERY_IN_TYUMEN"] = "Бесплатная доставка курьером по г. Тюмень на заказы свыше";
$MESS["NEED_MORE_PRODUCTS"] = ", для ее получения, добавьте в корзину товаров на сумму";
$MESS["PRODUCT_COST"] = "Стоимость товаров";
$MESS["SUMM_WITHOUT_DISCOUNT"] = "Стоимость без скидки:";
$MESS["DELETE_ITEM_NOTE"] = "Вы точно хотите удалить этот товар из корзины?";
$MESS["DELETE_ITEM_NOTE_YES"] = "Да";
$MESS["DELETE_ITEM_NOTE_CANCEL"] = "Отмена";
$MESS["DISCOUNT"] = "Скидка:";
$MESS["SUMM_TO_PAYMENT"] = "К оплате:";
$MESS["SUMM_WITHOUT_DELIVERY"] = "Итого, без учета доставки:";
