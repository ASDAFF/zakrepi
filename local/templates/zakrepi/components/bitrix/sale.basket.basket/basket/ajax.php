...
if (isset($_POST[$action_var]) && strlen($_POST[$action_var]) > 0)
{
	...
	else if ($_POST[$action_var] == "delete")
	{
		$arRes["delete_item"] = intval($_POST['delete_item']);

		if (intval($_POST['delete_item']) > 0){
			if (CSaleBasket::Delete(intval($_POST['delete_item'])))
    			$arRes["CODE"] = "SUCCESS";
		}
	}
	else if ($_POST[$action_var] == "deleteall")
	{
