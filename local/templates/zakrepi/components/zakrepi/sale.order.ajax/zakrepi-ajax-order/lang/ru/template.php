...
$MESS['SOA_TEMPL_HEADER'] = "Оформление заказа";
$MESS['ORDER_SUMMARY'] = "4. Ваш заказ";
$MESS['FREE_DELIVERY'] = "Бесплатно";
$MESS['ORDER_NOTICE'] = "Обращаем ваше внимание, что все заказы обрабатываются и отправляются в будние дни до 17:00</br>Заказы, совершенные после, обрабатываются уже на следующий день.";
$MESS['SOA_TEMPL_BUTTON'] = "Оформить заказ";
$MESS['SOA_TEMPL_DELIVERY'] = "2. Способ доставки";
$MESS['SOA_TEMPL_DELIVERY_ADDRESS'] = "Адрес доставки";
$MESS['SOA_TEMPL_CHANGE_ADDRESS'] = "Изменить адрес ";
$MESS['SOA_TEMPL_NEW_ADDRESS'] = "Указать новый адрес";
...
$MESS['SOA_TEMPL_PAY_SYSTEM'] = "3. Способ оплаты";
...
$MESS['SOA_TEMPL_DELIVERY'] = "2. Служба доставки";
$MESS['SOA_TEMPL_ORDER_SUC'] = "Номер заказа: ";
$MESS['SOA_TEMPL_ORDER_PERSON'] = "Получатель:";
$MESS['SOA_TEMPL_ORDER_PAYMENT'] = "Информация об оплате: ";
$MESS['SOA_TEMPL_ORDER_DELIVERY'] = "Информация о доставке: ";
$MESS['SOA_TEMPL_ORDER_INFO'] = "Состав заказа";
...
$MESS['SOA_TEMPL_ORDER_DELIVERY_PRICE'] = "Стоимость доставки: ";
$MESS['SOA_TEMPL_ORDER_ALL_PRICE'] = "Итого: ";
$MESS['SOA_TEMPL_ORDER_ITEMS_SUMM'] = "Общая стоимость товаров: ";
$MESS['SOA_TEMPL_THANKS_FOR_ORDER'] = "Спасибо за ваш заказ!";
...
$MESS['SOA_TEMPL_BUYER_INFO'] = "1. Контактные данные";
...
$MESS["SOA_TEMPL_SUMM"] = "на сумму:";
$MESS["SOA_TEMPL_AGREEMENT"] = "Нажимая кнопку «Оформить заказ», я автоматически соглашаюсь с условиями ";
$MESS["SOA_TEMPL_AGREEMENT_LINK"] = "Договора оферты";
?>