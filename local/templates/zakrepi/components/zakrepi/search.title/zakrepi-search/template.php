...
if($arParams["SHOW_INPUT"] !== "N"):?>
	...
	<form action="<?echo $arResult["FORM_ACTION"]?>">
		<input type="text" class="search inputtext" name="q" id="<?echo $INPUT_ID?>" autocomplete="off" />
        <label for="<?echo $INPUT_ID?>" class="textfield-placeholder">Поиск по товарам</label>
