...
$MESS["SOA_USER_GROUP"] = "К типу плательщика ";
$MESS["SOA_USER_GROUP_2"] = " относятся группы";
$MESS["SOA_DEFAULT_PERSON_TYPE_ID"] = "Тип плательщика по-умолчанию";
$MESS["SOA_CONTACT_PROPERTIES_GROUP"] = "Группа свойств с контактными данными для типа плательщика ";
$MESS["SOA_DELIVERY_PROPERTIES_GROUP"] = "Группа свойств для доставки курьером для типа плательщика ";
$MESS["SOA_PAYMENT_GROUP_1"] = "Платежные системы в блоке 'Прямо сейчас'";
$MESS["SOA_PAYMENT_GROUP_2"] = "Платежные системы в блоке 'При получении товара'";
